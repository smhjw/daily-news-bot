...
def ai_summarize(title, description):
    ...
    try:
        ...
        # Vibe Prompt 2.0: 拒绝翻译腔，更像人话
        prompt = f"""
        你是一位有着10年经验的资深国际新闻编辑。
        请阅读以下英文新闻，用**最地道、最符合中国人阅读习惯**的中文重写一段简报（100字以内）。
        
        关键要求：
        1. 🚫 **拒绝翻译腔**：严禁逐字直译！不要出现“它是被...”这种被动句态。
        2. 🗣️ **说人话**：用中文的逻辑重新组织语言，读起来要顺口、自然。
        3. 🎯 **抓重点**：直接告诉读者发生了什么事，省略次要的修饰词。
